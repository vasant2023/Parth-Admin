...
@Component({
  selector: 'app-hotel-category-list',
  templateUrl: './hotel-category-list.component.html',
  styleUrls: ['./hotel-category-list.component.css']
})
export class HotelCategoryListComponent implements OnInit {
