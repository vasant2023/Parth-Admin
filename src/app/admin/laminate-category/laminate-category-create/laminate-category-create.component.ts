...
@Component({
  selector: "app-laminate-category-create",
  templateUrl: "./laminate-category-create.component.html",
  styleUrls: ["./laminate-category-create.component.css"],
})
export class LaminateCategoryCreateComponent implements OnInit {
  categoryObj: any = {
    category: "",
    title: "",
    sub_title: "",
      ...
      .subscribe(
        (response: { success: number; message: string; category: any }) => {
          if (response.success == 1) {
            ...
            this.categoryObj.parent_category = parseInt(
              response.category.parent_category
            );
          } else {
      ...
      if (this.category_ID) {
        ...
        this.adminService
          ...
          .subscribe((response: { success: number; message: string }) => {
            if (response.success == 1) {
              this.router.navigate(["admin/laminate-category"]);
            }
