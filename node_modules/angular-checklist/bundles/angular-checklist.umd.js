(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('angular-checklist', ['exports', '@angular/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-checklist'] = {}, global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var ChecklistDirective = /** @class */ (function () {
        function ChecklistDirective() {
            ...
            this.checklistChange = new core.EventEmitter();
        }
        ////////////
        ...
        ChecklistDirective.prototype.triggerOnChange = function (target) {
            ...
            if (target && target.checked) {
                if (this.maxSelectedItems === -1 || checklist.length < this.maxSelectedItems) {
                    updatedList = __spread(checklist, [this.checklistValue]);
                ...
                updatedList = __spread(checklist.slice(0, i), checklist.slice(i + 1));
                this.checklistChange.emit(updatedList);
            }
        };
    ...
    ChecklistDirective.propDecorators = {
        checklist: [{ type: core.Input }],
        checklistValue: [{ type: core.Input }],
        maxSelectedItems: [{ type: core.Input }],
        checklistChange: [{ type: core.Output }],
        isChecked: [{ type: core.HostBinding, args: ['checked',] }],
        triggerOnChange: [{ type: core.HostListener, args: ['change', ['$event.target'],] }]
    };
...
//# sourceMappingURL=angular-checklist.umd.js.map
